...
website = 'officechairs'
# 全流程解析脚本

class OfficechairsSpider(scrapy.Spider):
    name = website
    # allowed_domains = ['officechairs.com']
    # start_urls = ['http://officechairs.com/']
    ...
    def __init__(self, **kwargs):
        super(OfficechairsSpider, self).__init__(**kwargs)
        self.counts = 0
        setattr(self, 'author', "")
