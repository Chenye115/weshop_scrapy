...
site_name = 'worlduniqueimports' # 站名 如 'shopweareiconic'
domain_name = 'worlduniqueimports.com' # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://worlduniqueimports.com/' # URL 前缀 如 'https://shopweareiconic.com'
