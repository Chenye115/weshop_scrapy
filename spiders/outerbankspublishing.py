...
website = 'outerbankspublishing'
# 全流程解析脚本

class OuterbankspublishingSpider(scrapy.Spider):
    name = website
    allowed_domains = ['outerbankspublishing.com']
    # start_urls = ['http://outerbankspublishing.com/']
    ...
    def __init__(self, **kwargs):
        super(OuterbankspublishingSpider, self).__init__(**kwargs)
        self.counts = 0
    ...
    def start_requests(self):
        #手动找分类
        url_list = [
            'https://www.outerbankspublishing.com/store/fiction/',
            'https://www.outerbankspublishing.com/store/nonfiction/',
        ]
        for url in url_list:
            print(url)
        ...
        #url = "http://outerbankspublishing.com/"
        #yield scrapy.Request(
        #    url=url,
        #)
