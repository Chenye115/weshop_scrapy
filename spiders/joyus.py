...
class JoyusSpider(scrapy.Spider):
    name = website
    allowed_domains = ['joyus.com']
    start_urls = ['http://joyus.com/']
    ...
    def __init__(self, **kwargs):
        super(JoyusSpider, self).__init__(**kwargs)
        self.counts = 0
        setattr(self, 'author', "")
    ...
    def start_requests(self):
        url_list = [
            'https://www.joyus.com/sales/18k-rose-gold-plated-halo-stud-earrings-w-swarovski-elements'
            'https://www.joyus.com/'
        ]
        for url in url_list:
            print(url)
