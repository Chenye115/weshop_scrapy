...
class FutonlandSpider(scrapy.Spider):
    name = website
    allowed_domains = ['futonland.com']
    start_urls = ['http://futonland.com/']
    ...
    def __init__(self, **kwargs):
        super(FutonlandSpider, self).__init__(**kwargs)
        self.counts = 0
